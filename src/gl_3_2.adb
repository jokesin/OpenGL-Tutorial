...
with Initialize;
with GL_Tutorials.Ex_3_Instanced_Rendering;

procedure GL_3_2 is
Main_Window : Glfw.Windows.Window;
   Program_Name : String := "OpenGL Tutorial - Instanced Rendering";
...
begin
   ...
   GL_Tutorials.Ex_3_Instanced_Rendering.Main_Loop(Main_Window);
