...
procedure Initialize
  (Main_Window  : in out Glfw.Windows.Window;
   Window_Title : String;
...
is
   ...
   procedure Set_Window_Hints is
      Min_Major_Version : constant Integer := 4;
      Minor_Version     : constant Integer := 3;
   begin
   ...
   Cursor        : constant Glfw.Input.Mouse.Cursor_Mode := Glfw.Input.Mouse.Hidden;
...
exception
   when others =>
      Put_Line("An exception in Initialize");
      raise;
