...
package body GL_Tutorials.Ex_4_Stencil_Test is
   ...
   begin
      ...
      -- рисуем цилиндр и заполн€ем буфер трафарета единицами
      -- в том месте, где рисуетс€ куб
      ...
      -- заполн€ем буфер трафарета двойками в том месте,
      ...
      -- если значение, наход€щеес€ в буфере трафарета
